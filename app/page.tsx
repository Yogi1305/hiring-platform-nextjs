        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <a
                href="/jobs"
                className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition-all hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
              >
              ...
              <a
                href="/employeer"
                className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-6 py-3 text-sm font-semibold text-slate-700 shadow-sm transition-all hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
              >
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 grid grid-cols-2 gap-4 lg:grid-cols-4">
          {[
            ...
            >
              <div className={`mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-xl ${stat.bg} ring-1 ${stat.ring}`}>
                <span className={`text-sm font-bold ${stat.color}`}>#</span>
              </div>
            ...
            {[
              {
                ...
                description:
                  'Sign up and build a professional profile showcasing your skills, experience, and education.',
                icon: (
              ...
              },
              {
                ...
                title: 'Browse & Apply',
                description:
                  'Explore thousands of job listings, filter by category, and apply with just a few clicks.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
                      d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              ...
              },
              {
                ...
                title: 'Get Hired',
                description:
                  'Connect directly with employers, ace your interviews, and land your dream job faster.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
              ...
              >
                ...
                <span className={`absolute -right-2 -top-2 text-7xl font-black ${item.stepColor} select-none`}>
                  {item.step}
                </span>
